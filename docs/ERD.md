...
| --- | --- | --- | --- |
| `bid-events` | Bid Service | Notification / WebSocket / Auto-Bid Service / ES Sync Consumer | 입찰 이벤트 |
| `auction-events` | Auction Service | Notification / Search Sync | 경매 생성/종료/취소 이벤트 |
